...
namespace EdukitConnector
{
    ...
    public class XGTClass
    {
        ...
        private string GetMemTypeChar(XGT_MemoryType type)
        {
            ...
            switch (type)
            {
                case XGT_MemoryType.P:
                    vReturn = XGT_Memory_TypeClass.P;
                    break;
                case XGT_MemoryType.M:
                    vReturn = XGT_Memory_TypeClass.M;
                    break;
                ...
                case XGT_MemoryType.Timer_T:
                    ...
                    break;
                case XGT_MemoryType.D:
                    vReturn = XGT_Memory_TypeClass.D;
                    break;
